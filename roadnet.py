...
file_path = '/home/wikus/code/ipt3/data/roadnet/file.xml'
...
try:
    with open(file_path, 'rb') as file:
        ...
        while True:
            ...
            if not byte:
                break  # End of file
            # Print byte value and its position
            print(f'Byte position: {byte_position}, Byte value: {byte}')
            byte_position += 1
            if byte_position == 100:
                break
except Exception as e:
    print(f'Error reading file at byte position {byte_position}: {e}')
